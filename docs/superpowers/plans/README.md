...
| 進行中           | Phase 3（Task 3-12 まで完了、残り 3-13 / 3-14）／ Phase 4 は計画書を執筆中               |
| テスト件数       | `packages/core` 326 ＋ `packages/geo` 205 ＋ `apps/api` 262 ＋ `apps/mobile` 128 = 921   |
...
数字は Task 3-12（シード生成）完了時点の実測。Task 3-13（3 段検索）と 3-14（品質ゲート）で
さらに増える。
...
| 3     | D1 スキーマ / マイグレーション / シード                      | 15           | [phase-3](./2026-09-15-phase-3-database.md)       | 実装中（3-11 完了 / 3-12 中） |
| 4     | API 基盤（Hono / 認証 / ロールガード / ブランド型 Actor）    | 執筆中       | [phase-4](./2026-09-15-phase-4-api-foundation.md) | 計画を執筆中                  |
