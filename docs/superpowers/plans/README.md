...
| 3     | D1 スキーマ / マイグレーション / シード                   |       12 | [phase-3](./2026-09-15-phase-3-database.md)       | 計画済み |
| 4     | API 基盤（Hono / 認証 / 権限の型設計 / 店舗検索）         |       12 | [phase-4](./2026-09-15-phase-4-api-foundation.md) | 計画済み |
| 5     | モバイル認証 + ロールルーティング                         |        9 | [phase-5](./2026-09-15-phase-5-auth-routing.md)   | 計画済み |
| 6     | 利用者コア（地図 / 検索 / 店舗詳細 / レビュー / 保存）    |       22 | [phase-6](./2026-09-15-phase-6-user-core.md)      | 計画済み |
...
詳細計画は着手直前に作る。先に全部書くと、前フェーズの実装で判明した事実が反映されず陳腐化するため。Phase 3〜6 は Phase 2 完了時点の実測値をもとに先行して作成済み。
...
| 2-12 | 公開 API バレル | `index.ts`                                                              | 公開シンボル一覧の固定 / スコア 85% 以上              |
